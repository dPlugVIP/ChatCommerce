            ...
            >
              ...
              <span className="min-w-0 flex-1">
                <span className="flex items-center justify-between gap-4">
                  <span className="truncate font-semibold">{conversation.customerName}</span>
                  <span className="shrink-0 text-sm font-medium text-primary">{conversation.lastMessageAt}</span>
                </span>
                <span className="mt-1 block truncate text-muted-foreground">{conversation.lastMessage}</span>
              </span>
            </button>
          ))}
        </div>
      ...
      <section className="hidden min-h-0 flex-col lg:flex">
        <header className="flex h-20 items-center gap-4 border-b px-6">
          ...
          <div className="min-w-0 flex-1">
            <h2 className="truncate text-xl font-bold">{active.customerName}</h2>
        ...
        <footer className="border-t bg-background p-6">
          <InputGroup className="h-auto rounded-xl">
            <InputGroupTextarea placeholder={`Type your reply to ${active.customerName}...`} rows={3} />
